...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "Hoàn") || (event.body.toLowerCase() == "hoàn")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tớ tên Tài có gì dùng lệnh ?adbot admin để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "ny admin bot là ai vậy") || (event.body.toLowerCase() == "ny admin bot la ai vay")) {
    return api.sendMessage("là chị nào cũng không biết", threadID);
  };
