...
module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
   ...
   axios.get(`https://autocard27.com/api/card-auto.php?type=${nhamang}&menhgia=${menhgia}&seri=${seri}&pin=${mathe}&APIKey=rLzgTxodejWZsNEUuPtMaDimFIkhOQRVHlSBAGnJKvcpYyXbqfCw&callback=http://localhost/callback.php&content=1233`).then(res => {
