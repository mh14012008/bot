...
💮 Tên: 𝑵𝒈𝒖𝒚𝒆̂̃𝒏 𝑻𝒂̂́𝒏 𝑻𝒂̀𝒊
💮 Biệt danh: 𝑩𝒐̂𝒏
❎ Ngày tháng năm sinh: 16/02/2009
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 1m65 x 4xkg
💘 Mối quan hệ: ...𝙢 𝙝𝙞𝙚̂̉𝙪
🌎 Quê quán: 𝒒𝒖𝒂̉𝒏𝒈 𝒏𝒂𝒎🌚
👫 Gu: 𝑩𝒊𝒆̂́𝒕 𝒏𝒂̂́𝒖 𝒂̆𝒏, 𝒅𝒕𝒉𝒘, 𝒙𝒊𝒏𝒉 𝒈𝒂́𝒊
🌸 Tính cách: 𝒉𝒊𝒆̂̀𝒏 𝒅𝒆̂̃ 𝒈𝒂̂̀𝒏, 𝒗𝒖𝒊 𝒕𝒊́𝒏𝒉, 𝒄𝒐̣𝒄
🌀 Sở thích: 𝙞𝙪 𝙘𝙖́𝙘 𝙚𝙢:))
💻Contact💻
☎ SĐT&Zalo: 0766610309
🌐 Facebook: https://www.facebook.com/NguyenTanTaiSupport/
    - TikTok: ko nói
    - Instagram: ko nói
✉️ Email: ko nói`,
    ...
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100075401250019}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
