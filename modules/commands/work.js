...
var rdcn = ['𝘁𝘂𝘆𝗲̂̉𝗻 𝗱𝘂̣𝗻𝗴 𝗻𝗵𝗮̂𝗻 𝘃𝗶𝗲̂𝗻 𝗰𝗵𝗼 𝐇𝐢𝐞̂́𝐮', '𝗾𝘂𝗮̉𝗻 𝘁𝗿𝗶̣ 𝗸𝗵𝗮́𝗰𝗵 𝘀𝗮̣𝗻', '𝘁𝗮̣𝗶 𝗻𝗵𝗮̀ 𝗺𝗮́𝘆 ', '𝗯𝗲̂́𝗽 𝘁𝗿𝘂̛𝗼̛̉𝗻𝗴 𝘁𝗿𝗼𝗻𝗴 𝗻𝗵𝗮̀ 𝗵𝗮̀𝗻𝗴', '𝗰𝗼̂𝗻𝗴 𝗻𝗵𝗮̂𝗻', '𝗽𝗵𝘂̣ 𝗵𝗼̂̀']; //random công việc khi làm ở khu công nghiệp
var work1 = rdcn[Math.floor(Math.random() * rdcn.length)];   

var rddv = ['𝘀𝘂̛̉𝗮 𝗼̂́𝗻𝗴 𝗻𝘂̛𝗼̛́𝗰', '𝘀𝘂̛̉𝗮 𝗺𝗮́𝘆 𝗹𝗮̣𝗻𝗵', '𝗯𝗮́𝗻 𝗸𝗲𝗺 𝘁𝗿𝗼̣̂𝗻', '𝗽𝗵𝗮́𝘁 𝘁𝗼̛̀ 𝗿𝗼̛𝗶', '𝘀𝗵𝗶𝗽𝗽𝗲𝗿', '𝘀𝘂̛̉𝗮 𝗣𝗖', '𝗵𝘂̛𝗼̛́𝗻𝗴 𝗱𝗮̂̃𝗻 𝘃𝗶𝗲̂𝗻 𝗱𝘂 𝗹𝗶̣𝗰𝗵', '𝘆 𝘁𝗮́']; //random công việc khi làm ở khu dịch vụ
...
var work6 = rddd1[Math.floor(Math.random() * rddd1.length)];
  ...
  var rdex1 = ['𝗹𝗮̀𝗺 𝗼̂ 𝘀𝗶𝗻 𝗰𝗵𝗼 𝗮𝗱𝗺𝗶𝗻', '𝗹𝗮̀𝗺 𝗯𝗼̂̀𝗻 𝗰𝗮̂̀𝘂 𝗻𝗵𝘂̛ 𝗱𝘂𝗯𝗮𝗶', '𝗯𝗮̆́𝘁 𝗰𝘂̛𝗼̛́𝗽', '𝗹𝗮̀𝗺 𝗰𝗮𝘃𝗲 ', '𝗰𝗵𝗮𝘁 𝘀𝗲𝘅 𝘃𝗼̛́𝗶 𝗮𝗱𝗺𝗶𝗻', '𝘁𝗵𝘂̉ 𝗱𝗮̂𝗺']; //random công việc khi thử thách 
var work7 = rdex1[Math.floor(Math.random() * rdex1.length)];

  var rdex12 = ['𝗿𝘂̛𝗼̛́𝗰 đ𝗲̀𝗻 𝘁𝗿𝘂𝗻𝗴 𝘁𝗵𝘂', 'đ𝗶̣𝘁 𝗴𝗮́𝗶 𝗸𝗵𝗼̂𝗻𝗴 𝘁𝗿𝗮̉ 𝘁𝗶𝗲̂̀𝗻 𝘃𝗮̀ 𝗯𝗶̣ 𝗯𝗮̆́𝘁', '𝗯𝗮́𝗻 đ𝗮̣̂𝘂 𝗽𝗵𝘂̣ 𝘁𝗮̂̉𝗺 𝗺𝗮 𝘁𝘂𝘆́ 𝘃𝗮̀ 𝗯𝗶̣ 𝗯𝗮̆́𝘁', '𝘁𝗿𝗼̣̂𝗺 𝗺𝗲̀𝗼 𝗻𝗵𝗮̀ 𝗼̂𝗴 𝗯𝗮̀ 𝗧𝗮̂𝗺 𝗣𝗵𝘂̛𝗼̛𝗻𝗴 đ𝗲̂̉ 𝗯𝗮́𝗻', '𝗴𝗶𝘂́𝗽 𝗯𝗮̣𝗻 𝗠𝗮̣𝗻𝗵 𝗺𝗲̀𝗼 𝗯𝗮́𝗻 đ𝗮̣̂𝘂 𝗽𝗵𝘂̣', 'đ𝗶̣𝘁 𝘀𝗼̛𝗻 đ𝗲𝗻', '𝘁𝗿𝗼̣̂𝗺 𝗱𝘂̛̀𝗮 𝗻𝗵𝗮̀ 𝗼̂𝗻𝗴 𝗡𝗮̆𝗺 𝗠𝗶𝗻𝗵']; //random công việc khi thử thách 
    ...
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(event.body) {
                ...
                case "7": msg = `𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝗻𝗵𝗮̣̂𝗻 𝘁𝗵𝘂̛̉ 𝘁𝗵𝗮́𝗰𝗵 𝟮𝟰𝗵 ${work7} 𝗩𝗮̀ 𝗻𝗵𝗮̣̂𝗻 𝘃𝗲̂̀ ${coinsex1}$ 
 🌸`; await Currencies.increaseMoney(event.senderID, parseInt(coinsex1)); break;
                case "8": msg = `𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 ${work8} 𝗼̛̉ 𝗧𝗿𝗮̣𝗶 𝗖𝗮̉𝗶 𝗧𝗮̣𝗼 𝘃𝗮̀ 𝗸𝗶𝗲̂́𝗺 𝘃𝗲̂̀ ${coinsex12}$ 🌸`; await Currencies.increaseMoney(event.senderID, parseInt(coinsex12)); break;
            };
...
module.exports.run = async ({  event, api, handleReply, Currencies, getText }) => {
    ...
    return api.sendMessage("◆━🌸 𝗪𝗢𝗥𝗞𝗜𝗡𝗚 🌸━◆" +
                "\n\n𝟏. 𝐊𝐡𝐮 𝐜𝐨̂𝐧𝐠 𝐧𝐠𝐡𝐢𝐞̣̂𝐩 🏬" +
                "\n𝟐. 𝐊𝐡𝐮 𝐝𝐢̣𝐜𝐡 𝐯𝐮̣ 🏢" +
                "\n𝟑. 𝐊𝐡𝐮 𝐦𝐨̉ 𝐝𝐚̂̀𝐮 🕳️" +
                "\n𝟒. 𝐊𝐡𝐚𝐢 𝐭𝐡𝐚́𝐜 𝐪𝐮𝐚̣̆𝐧𝐠 ⛏️💎" +
                "\n𝟓. 𝐊𝐡𝐚𝐢 𝐓𝐡𝐚́𝐜 ⛏️⛰️" +
                "\n𝟔. 𝐂𝐚𝐯𝐞 𝐓𝐫𝐚̂̀𝐧 𝐃𝐮𝐲 𝐇𝐮̛𝐧𝐠 💃" +
                "\n𝟕. 𝐓𝐡𝐮̛̉ 𝐭𝐡𝐚́𝐜𝐡 🔐" +
                "\n𝟖. 𝗧𝗿𝗮̣𝗶 𝗖𝗮̉𝗶 𝗧𝗮̣𝗼 💣" +
